		...
		<div id="app">
			...
			<div class="forum-container" :style='{"padding":"20px","boxShadow":"1px 1px 6px rgba(156,187,252,8)","margin":"0","borderColor":"rgba(156, 187, 252, 0.3)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0","borderStyle":"solid"}'>
				<form class="layui-form login-form" lay-filter="myForm">
					...
					<div  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}' class="layui-form-item layui-form-text">
					...
					<div class="layui-form-item">
						<div class="layui-input-block" style="text-align: right;margin-right: 30px;">
							<button style="outline:none" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"10px auto 0","borderColor":"#ccc","backgroundColor":"rgba(156, 187, 252, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' class="layui-btn btn-submit" lay-submit lay-filter="*">修改</button>
							<button style="outline:none":style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"10px auto","borderColor":"#ccc","backgroundColor":"rgba(156, 187, 252, 1)","color":"rgba(255, 255, 255, 1)","borderRadius":"8px","borderWidth":"0","width":"60%","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="reset" class="layui-btn layui-btn-primary">重置</button>
						</div>
					</div>
				</form>
			</div>
