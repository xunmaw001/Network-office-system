		...
		<div id="app">
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 6px rgba(255,254,255,1)","margin":"10px 0 0 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(255, 254, 255, 1)","borderRadius":"0","borderWidth":"0","background":"rgba(255,255,255,1)","borderStyle":"solid"}'>
				<div class="box" style='width:80%'>
					...
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"transparent","color":"#fff","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>文件类型</div>
						<select :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"#ccc","backgroundColor":"#fff","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"0","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' style="display:block" name="wenjianleixing" id="wenjianleixing" lay-filter="wenjianleixing">
							<option value="">请选择</option>
							<option v-for="(item,index) in wenjianleixingOptions" v-bind:key="index" :value="item">{{item}}</option>
						</select>
					</div>
		...
		<div v-if="1 == 1" style="position: absolute;left: 0;top: 0;transform: translate3d(-100%, 0, 0);" :style='{"padding":"0","boxShadow":"0 0 0px rgba(156,187,252,1)","margin":"0px 0px 0 -30px","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"84px","borderStyle":"solid","height":"auto"}'>
			...
			<div v-for="(item,index) in categoryList" :key="index" >
				<div style="text-align: center;cursor: pointer;box-sizing: border-box;" :style='swiperIndex==index?{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.0)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(39, 90, 255, 1)","color":"#fff","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}:{"padding":"0 10px","boxShadow":"0 0 6px rgba(0,0,0,.3)","margin":"4px 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","borderWidth":"0","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"solid"}' :index="index" class="category-search">{{categoryList[index]}}</div>
							...
							<div @click="jump('../gongxiangwenjian/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="3=='3'?'list-item3':3=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"10px","boxShadow":"0 0 6px rgba(39,90,187,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"#fff","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 6px rgba(39,90,187,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","width":"280px","borderStyle":"solid","height":"200px"}' :src="item.fengmiantupian?baseurl+item.fengmiantupian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(29, 3, 3, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}' class="name">{{item.biaoti}}</div>
									</div>
								</div>
							</div>
						</div>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
        			...
        			http.request(`option/wenjianleixing/wenjianleixing`,'get',{},(res)=>{
                			vue.wenjianleixingOptions = res.data
        			});
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/wenjianleixing/wenjianleixing', 'get', {}, function(res) {
				...
				if(category!=null && category!='全部') {
					...
					if (jquery('#wenjianleixing').val()) {
						param['wenjianleixing'] = '';
					}
				}
				if(vCategory!='' && category!='全部') {
					param['wenjianleixing'] = category;
				}
			        ...
			        if (jquery('#wenjianleixing').val()) {
			          param['wenjianleixing'] = jquery('#wenjianleixing').val() ? jquery('#wenjianleixing').val() : '';
			        }
				...
				if (jquery('#wenjianleixing').val()) {
					...
					// 获取列表数据
					http.request('gongxiangwenjian/list', 'get', param, function(res) {
