				...
				<div class="layui-row" style="display: flex;width:980px;margin: 0 auto;">
					...
					<div class="layui-col-md7" style="padding-left: 20px;flex: 1;" :style='{"padding":"0","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0 0 0 20px","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"1px","borderStyle":"solid"}'>
						...
						<div :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>文件类型：</span>
							<span  :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"22px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.wenjianleixing}}
							</span>
						</div>
						<div :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>上传日期：</span>
							<span  :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"22px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.shangchuanriqi}}
							</span>
						</div>
						<div :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>员工工号：</span>
							<span  :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"22px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yuangonggonghao}}
							</span>
						</div>
						<div :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>员工姓名：</span>
							<span  :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"22px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.yuangongxingming}}
							</span>
						</div>
						<div :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>部门：</span>
							<span  :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(0, 0, 0, 1)","backgroundColor":"#fff","color":"#333","borderRadius":"4px","textAlign":"left","borderWidth":"1px","width":"auto","lineHeight":"22px","fontSize":"14px","borderStyle":"solid"}' class="desc">
								{{detail.bumen}}
							</span>
						</div>
						...
						<div :style='{"padding":"4px 15px","boxShadow":"0 0 6px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 1px 0","borderStyle":"solid"}' class="detail-item">
							<span :style='{"padding":"0 12px 0 0","minWidth":"94px","fontSize":"14px","color":"rgba(0, 0, 0, 1)","textAlign":"right"}'>文件：</span>
							<span class="desc">
								<a style="display:block;" :style='{"padding":"0 15px","boxShadow":"0 0 6px rgba(110,22,64,0)","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(156, 187, 252, 1)","color":"#fff","borderRadius":"4px","textAlign":"center","borderWidth":"0","width":"auto","lineHeight":"28px","fontSize":"14px","borderStyle":"solid"}' download="wenjian" :href="baseurl+detail.wenjian">点击下载</a>
							</span>
						</div>
					...
					<div class="layui-tab layui-tab-card" :style='{"boxShadow":"0 0 6px rgba(156, 187, 252, 1)","borderColor":"rgba(110,22,64,.3)","backgroundColor":"#fff","borderRadius":"10px","borderStyle":"solid","borderWidth":"0px"}' style="overflow: hidden;">
						...
						<div style="word-break:break-all" class="layui-tab-content">
							...
							<div class="layui-tab-item layui-show">
								<div v-html="detail.wenjianjieshao"></div>
							</div>
			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable,statusColumnName,tips,statusColumnValue){
						localStorage.setItem('crossTable',`gongxiangwenjian`);
