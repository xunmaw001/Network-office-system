					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block input">
								<input type="text" readonly="readonly" name="yuangonggonghao" name="yuangonggonghao" id="yuangonggonghao" placeholder="员工工号" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block input">
								<input type="text"  name="bumen" name="bumen" id="bumen" placeholder="部门" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							<label  :style='{"width":"94px","padding":"0 12px 0 0","fontSize":"14px","color":"#333","textAlign":"right"}' class="layui-form-label">员工手机</label>
							<div class="layui-input-block input">
								<input type="text"  name="yuangongshouji" name="yuangongshouji" id="yuangongshouji" placeholder="员工手机" autocomplete="off" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block">
								<img id="zhaopianImg" style="width: 100px;height: 100px;border-radius: 50%;border: 2px solid #EEEEEE;" :style='{"boxShadow":"0 0 6px rgba(156,187,252,0)","borderColor":"rgba(156, 187, 252, 1)","backgroundColor":"#fff","borderRadius":"10px","borderWidth":"1px","width":"80px","borderStyle":"solid","height":"80px"}' src="../../img/avator.png">
						...
						<div class="layui-form-item"  :style='{"padding":"10px","boxShadow":"0 0 6px rgba(156,187,252,0)","margin":"0 0 10px 0","borderColor":"rgba(39, 90, 187, 1)","backgroundColor":"#fff","borderRadius":"0","borderWidth":"0 0 3px 0","borderStyle":"dotted"}'>
							...
							<div class="layui-input-block">
								<button :style='{"padding":"0 10px","boxShadow":"0 0 6px rgba(110,22,64,0)","margin":"0 10px 0 0","borderColor":"#ccc","backgroundColor":"rgba(156, 187, 252, 1)","color":"#fff","borderRadius":"8px","borderWidth":"0","width":"auto","fontSize":"14px","borderStyle":"solid","height":"44px"}' type="button" class="layui-btn btn-theme" id="zhaopianUpload">
