...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">文件类型管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>文件类型管理</span></li>
								<li class="breadcrumb-item active"><span>文件类型列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">文件类型列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										文件类型
									</label>
									<input type="text" id="wenjianleixingSearch" class="form-control form-control-sm" placeholder="请输入文件类型" aria-controls="tableId">
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#wenjianleixingSearch').val() != null && $('#wenjianleixingSearch').val() != ''){
				searchForm.wenjianleixing ="%" +  $('#wenjianleixingSearch').val() + "%";
			}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("wenjianleixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function getSum(colName){
		http("wenjianleixing"+colName,"GET",{
			tableName: "wenjianleixing",
			columnName: colName
		},(res)=>{
			if(res.code == 0){
				return res.data.sum;
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"wenjianleixing");
