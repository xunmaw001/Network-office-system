	...
	<div class="container" style="position: relative;">
		...
		<div class="" id="login-wrapper">
			...
			<form id="registerForm" action="" method="post">
							...
							<input  name="yuangonggonghao" placeholder="员工工号" class="form-control-i">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
							<label class="label">员工手机</label> 
							<input  name="yuangongshouji" placeholder="员工手机" class="form-control-i">
							</div>
