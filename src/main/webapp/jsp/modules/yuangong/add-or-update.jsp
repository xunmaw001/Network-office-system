...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>员工手机</label>
										<input name="yuangongshouji" id="yuangongshouji" name="yuangongshouji" class="form-control" placeholder="员工手机">
									</div>
									<div class="form-group col-md-6">
										<label>照片</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#yuangongshouji").val(ruleForm.yuangongshouji);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yuangongshouji != null && res.data.yuangongshouji != ''){

						$("#yuangongshouji").val(res.data.yuangongshouji);
						$("#yuangongshouji").attr('readonly','readonly');
					}
