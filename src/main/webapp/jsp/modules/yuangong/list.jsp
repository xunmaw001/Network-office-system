...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="yuangonggonghaoSearch" class="form-control form-control-sm" placeholder="请输入员工工号" aria-controls="tableId">
									<label>
										员工姓名
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('yuangongshouji')">员工手机<i id="yuangongshoujiIcon" class="fa fa-sort"></i></th>
											<th>照片</th>
											<th>操作</th>
										</tr>
									</thead>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yuangongshoujiCell  = document.createElement('td');

						 yuangongshoujiCell.innerHTML = item.yuangongshouji;

			row.appendChild(yuangongshoujiCell);
