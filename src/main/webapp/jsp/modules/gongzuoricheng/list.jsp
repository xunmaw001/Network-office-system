...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">工作日程管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>工作日程列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">工作日程列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										日程标题
									</label>
									<input type="text" id="richengbiaotiSearch" class="form-control form-control-sm" placeholder="请输入日程标题" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('richengbiaoti')">日程标题<i id="richengbiaotiIcon" class="fa fa-sort"></i></th>
											<th>图片</th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#richengbiaotiSearch').val() != null && $('#richengbiaotiSearch').val() != ''){
				searchForm.richengbiaoti ="%" +  $('#richengbiaotiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("gongzuoricheng/page","GET",{
				...
				sort: sortColumn,
				order: sortOrder,
				richengbiaoti : searchForm.richengbiaoti,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var richengbiaotiCell  = document.createElement('td');

						 richengbiaotiCell.innerHTML = item.richengbiaoti;

			row.appendChild(richengbiaotiCell);
			var richengneirongCell  = document.createElement('td');
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("gongzuoricheng/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"gongzuoricheng");
